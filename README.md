...
-   `CHANGELOG.md`: summary of significant changes to the `main` branch
-   `dependencies.sh`: a shell script to report installed package versions
-   `LICENSE`: MIT license
-   `README.md`: this file
-   `skip.txt`: a URL pattern for [linkcheck] to ignore

To serve the [Agda-Pages] website locally at port 8000:
...
To deploy the [Agda-Pages] website to GitHub Pages:
...
This project does *not* accept contributions generated by, or created through
the use of, tools based on large language models (LLMs), including, but
not limited to, tools like Claude (incl. Claude Code), ChatGPT, Gemini,
